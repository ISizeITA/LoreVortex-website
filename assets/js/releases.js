...
const FALLBACK = {
  desktop: {
    version: "1.13.7",
    url: "https://github.com/ISizeITA/LoreVortex-releases/releases/download/v1.13.7/LoreVortex_1.13.7_x64-setup.exe",
    assetName: "LoreVortex_1.13.7_x64-setup.exe",
  },
  mobile: {
    version: "1.13.7",
    url: "https://github.com/ISizeITA/LoreVortex-Mobile/releases/download/v1.13.7/LoreVortex_1.13.7_android-arm64.apk",
    assetName: "LoreVortex_1.13.7_android-arm64.apk",
  },
};
